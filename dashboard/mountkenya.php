  ...
  <th>Premise No.</th>
      ...
      <th>Action</th>
              ...
              while ($row = mysqli_fetch_array($result)) {
                ...
                echo '<td><div align="center"><a rel="facebox" href="view_mtkenya.php?id=' . $row['pr_id'] . '"><i class="fas fa-eye"></i></a> | <a href="? id="' . $row['pr_id'] . '" class="delbutton" title="Click To Delete"><i class="fas fa-trash"></i></a></div></td>';
                echo "</tr>";
              }
              echo "</table>";
            }
