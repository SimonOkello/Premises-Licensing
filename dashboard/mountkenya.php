              ...
              <?php if (!empty($premises)) { ?>
                <?php foreach ($premises as $premise) { ?>
                  <tr>
                    ...
                    <td>
                      <div align="center"><a rel="facebox" href="view_mtkenya.php?id=<?php echo $premise["pr_id"]; ?>"><i class="fas fa-eye"></i></a>|<a rel="facebox" href="#?id=<?php echo $premise["pr_id"]; ?>"><i class="fas fa-trash"></i></a></div>
                    </td>
                  </tr>
                <?php } ?>
              <?php } ?>
