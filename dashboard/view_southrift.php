                ...
                <div class="user-dashboard">
                    ...
                    <div class="row">
                        ...
                        <div class="container">
                            ...
                            ?>
                            <form action="view_southrift.php" method="POST" role="form" class="form-horizontal">
                                ...
                                <div class="form-group row">
                                    <div class="col-md-4">
                                        <a rel="facebox" class="btn btn-primary" href="edit_southrift.php?id=' . $row['pr_id'] . '">Update data</a>
                                    </div>
                                </div>
                            </form>
                        </div>
